...
export const ExifTags: Record<number, { name: string; type: IFDTypes, count?: number }> = {
  0x002: { name: "InteropVersion", type: IFDTypes.UNDEFINED },
  ...
  0x013e: { name: "WhitePoint", type: IFDTypes.RATIONAL }, //! [n]
  0x013f: { name: "PrimaryChromatics", type: IFDTypes.RATIONAL }, //! [n]

  0x0211: { name: "YCbCrCoefficients", type: IFDTypes.RATIONAL }, //! [n]
  0x0213: { name: "YCbCrPositioning", type: IFDTypes.SHORT }, //! [n]
  ...
  0x8827: { name: "ISO", type: IFDTypes.SHORT }, //! [n]x
